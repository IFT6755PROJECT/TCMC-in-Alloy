...
// 3. Locking -> washing -> drying -> unlocking
abstract sig Feature {}
one sig Wash, Delay, Dry extends Feature { }
abstract sig Status {}
one sig Locking, Washing, Drying, Unlocking extends Status{ }
...
pred validTransition[s,s' : State ]{
  // TODO
s.S=Locking =>  s'.S=Washing 
s.S=Washing => s'.S=Drying
